		...
		<div id="page-wrapper">
			<div class="main-page">
					...
					<div class="tables">
						...
						<h3 class="title1">Today Placed(Not Paid) Bill</h3>
...
$sq="select * from place_order where date between '$date1' and '$date2' and status!='paid' order by id desc LIMIT $offset, $rowsperpage";
