...
$s="select * from delivery where id='".$id."' " ;
...
$up2 ="UPDATE delivery SET title='".$title."',des='".$des."'  WHERE id=".$id." ";

$r2=mysqli_query($con,$up2);
 
if($r2){
 echo "<script>alert('Thank you for Updating Delivery page');window.location.href='".$_SERVER['REQUEST_URI']."'</script>";
 }   
