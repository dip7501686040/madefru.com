    ...
    <div class="main-page">
        ...
        <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                <?php
                    $sl=0; 
                    $query1="select * from seller_product where status='not-approved' order by seller_product_id desc";
                ...
                <tr>
                    ...
                    <td><?php echo"<a href='approve_seller_product.php?seller_product_id=$prow[seller_product_id]&seller_id=".urlencode($prow['seller_id'])."' class='btn btn-primary btn-sm' style='padding: 2px; margin: 2px;'>
                                Edit</a><a href='delete_not_approved_product.php?seller_product_id=$prow[seller_product_id]' class='btn btn-primary btn-sm' style='padding: 2px; margin: 2px;' onclick='return send();'>
                                Delete</a>"; ?></td>
                </tr>
                <?php } ?>
            </tbody>
